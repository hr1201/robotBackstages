<template>
    <div class="post-position">
        <div class="post-card">
            <h3>组员的任务</h3>
            <textarea placeholder="安排组员的默认任务" v-model="tasks.task"></textarea>

            <h3>提示</h3>
            <textarea class="description" placeholder="给组员的提示" v-model="tasks.description"></textarea>
...
const post=()=>{
    ...
    saveGroupTask(tasks.value).then((response)=>{
